...
ggplot(normalized_counts, aes(x = WT_ITG_0_IP, y = WT_ITG_48_IP)) +
  ...
  # geom_point() +
  stat_cor() +
  ggtitle("H3K27me3 WT (OE) Peak counts") +
  xlab("Pre-Firre induction (0h)") +
  ylab("Post-Firre induction (48h)")+
  xlim(0,10000) +
  ylim(0,10000)
ggsave("figures/h3k27me3_WT_0_vs_48_normalized_counts_noshow.pdf", height = 2.5, width = 2.5, useDingbats = FALSE)
ggplot(normalized_counts, aes(x = WT_ITG_0_IP, y = WT_ITG_48_IP)) +
  geom_abline(slope = 1, lty = 2) +
  geom_point() +
  # stat_cor() +
  ...
  ylab("Post-Firre induction (48h)") +
    xlim(0,10000) +
  ylim(0,10000)
ggsave("figures/h3k27me3_WT_0_vs_48_normalized_counts_noshow.png", height = 2.5, width = 2.5)

ggplot(normalized_counts, aes(x = KO_ITG_0_IP, y = KO_ITG_48_IP)) +
  geom_abline(slope = 1, lty = 2) +
  # geom_point() +
  stat_cor() +
    ggtitle("H3K27me3 KO (Rescue) Peak counts") +
  xlab("Pre-Firre induction (0h)") +
  ylab("Post-Firre induction (48h)")  +
  xlim(0,11000) +
  ylim(0,11000)
ggsave("figures/h3k27me3_KO_0_vs_48_normalized_counts_noshow.pdf", height = 2.5, width = 2.5, useDingbats = FALSE)
...
ggplot(normalized_counts, aes(x = KO_ITG_0_IP, y = KO_ITG_48_IP)) +
  ...
  xlim(0,11000) +
  ylim(0,11000)
ggsave("figures/h3k27me3_KO_0_vs_48_normalized_counts_noshow.png", height = 2.5, width = 2.5)

ggplot(rlogipcounts, aes(x = WT_ITG_0_IP, y = WT_ITG_48_IP)) +
  geom_point()

ggplot(rlogipcounts, aes(x = KO_ITG_0_IP, y = KO_ITG_48_IP)) +
  geom_point()

...
cat("#!/bin/bash \n", file = "copy_fastqs_to_scratch.sh")
write.table(cp_df, "copy_fastqs_to_scratch.sh", append = TRUE,
...
write.table(md5_df, "md5_list.txt",

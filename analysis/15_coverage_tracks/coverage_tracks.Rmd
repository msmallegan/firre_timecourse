...
p_rnaseq <- BigwigTrack(duox_shf_region, test_short_bws,
                         y_label = "RNA-seq \n Normalied signal",
...
Okay, so the RNA-seq doesn't appear to be from a stranded library prep. Therefore it would be better to plot this in an unstranded way.

```{r}
rs_bw <- list.files("/scratch/Shares/rinn/Michael/firre_timecourse/rnaseq1/bw")
```

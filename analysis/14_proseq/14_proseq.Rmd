...
bidir_counts <- read_rds("results/bidir_counts.rds")
# srun --pty -p short --ntasks 1 --mem 16G /bin/bash
library(Rsubread)
library(tidyverse)
fl <- list.files("/scratch/Shares/rinn/Michael/firre_timecourse/proseq/results/mapped/bams", 
                 pattern = "*.bam$",
...
bidir_counts <- featureCounts(fl, 
                              ...
                              nthreads = 21,
                              tmpDir = "/tmp")
write_rds(bidir_counts, "/scratch/Shares/rinn/Michael/firre_timecourse/analysis/14_proseq/results/bidir_counts_negative_strand.rds")
```

---
title: "Differential Expression: Firre WT mESC dox"
...
res_tbl_list <- mapply(
    ...
    MoreArgs = list(
        ...
        headerLevel = 2,
        write = TRUE,
        dir = paste0(params$results_dir,"/wt_dox_shrunken", collapse = "")
    ),
    SIMPLIFY = FALSE,
    USE.NAMES = TRUE
)
...
ggsave(filename = "mesc_wt_dox_responsive_heatmap.pdf", height = 47, width = 7.5)

write.csv(deg_profiles, "results/dox_responders_firre_wt_mesc.csv", row.names = F)
```
